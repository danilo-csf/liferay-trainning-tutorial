...
public class GuestbookPortlet extends MVCPortlet {
	...
	public void addEntry(ActionRequest request, ActionResponse response)
		...
		ServiceContext serviceContext = ServiceContextFactory
				.getInstance(Entry.class.getName(), request);
		...
		try {
			if (entryId > 0) {
				_entryLocalService.updateEntry(serviceContext.getUserId(),
				...
				_entryLocalService.addEntry(serviceContext.getUserId(),
	...
	public void render(RenderRequest renderRequest,
		...
		try {
			...
			List<Guestbook> guestbooks = _guestbookLocalService
