...
public class EntryIndexer extends BaseIndexer<Entry> {
	...
	public EntryIndexer() {
		...
		setDefaultSelectedFieldNames(Field.COMPANY_ID, Field.ENTRY_CLASS_NAME,
	...
	public boolean hasPermission(PermissionChecker permissionChecker,
		...
		return EntryPermission.contains(permissionChecker, entryClassPK,
				ActionKeys.VIEW);
	}
	...
	public void postProcessSearchQuery(BooleanQuery searchQuery,
		...
		addSearchLocalizedTerm(searchQuery, searchContext, "guestbookName",
				false);
